...
export const MOCK_MASSEUSES: Masseuse[] = [
  { id: 1, stageName: "Valentina", bio: "Especialista en rituales tántricos y terapias de contacto total, con más de 5 años de experiencia.", photoUrl: null, displayOrder: 1, isActive: true },
  { id: 2, stageName: "Isabella", bio: "Experta en masajes sensoriales y experiencias en pareja, enfocada en la conexión y la calidez.", photoUrl: null, displayOrder: 2, isActive: true },
  { id: 3, stageName: "Camila", bio: "Terapeuta certificada en recuperación muscular y piedras volcánicas.", photoUrl: null, displayOrder: 3, isActive: true },
  { id: 4, stageName: "Sofía", bio: "Especialista en masajes a cuatro manos y rituales L'AMOUR.", photoUrl: null, displayOrder: 4, isActive: true },
];
