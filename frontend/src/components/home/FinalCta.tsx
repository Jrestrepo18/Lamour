    ...
    <section className="relative isolate overflow-hidden bg-ink py-24 sm:py-28">
      ...
      <Container className="relative text-center">
        <Reveal>
          ...
          <h2 className="mx-auto mt-5 max-w-2xl font-serif text-4xl font-semibold leading-tight tracking-tight text-ivory text-balance sm:text-5xl">
            Regálate una pausa. Regálate L&apos;AMOUR.
          </h2>
          <p className="mx-auto mt-5 max-w-md text-base leading-relaxed text-ivory/75">
            Reserva en minutos y recibe una experiencia diseñada para tus sentidos, en la comodidad de tu hogar.
          </p>
          <div className="mt-9 flex flex-wrap items-center justify-center gap-4">
            <LinkButton href="/reservar" size="lg" variant="light">
              Reservar ahora
            </LinkButton>
            <Link
              href="/servicios"
              className="text-sm font-medium text-ivory underline decoration-gold/60 underline-offset-8 transition-colors hover:decoration-ivory"
            >
              Explorar servicios
            </Link>
          </div>
